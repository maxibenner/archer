...
async function init3D() {
    ...
    let cubeTexture = cubeLoader.load([
        '../images/envMap2/posx.jpg', '../images/envMap2/negx.jpg',
        '../images/envMap2/posy.jpg', '../images/envMap2/negy.jpg',
        '../images/envMap2/posz.jpg', '../images/envMap2/negz.jpg'
    ])
    ...
    var geometry = new THREE.PlaneGeometry(5.45, 5.45);
    ...
    pedestalMirror.position.y = 0;
    pedestalMirror.rotateX( -90 * Math.PI/180)
